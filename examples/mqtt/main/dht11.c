...
static void errorHandle(int response)
{
	switch(response) {
...
static int getData(int type, envT* pdata)
{
...
int getFtemp()
{
	int Data  = getData(2, NULL);
	return Data;	
}
int getTemp()
{
	int Data = getData(1, NULL);
	return Data;
}
int getHumidity()
{
	int Data  = getData(0, NULL);
	return Data;
}

int getEnvData(envT* edp)
{
	return(getData(3, edp));
}
